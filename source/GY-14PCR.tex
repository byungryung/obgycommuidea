...
\highlightY{2018년 검사코드 변경}으로 STD  균중  \emph{Single PCR로 Candida albicans,  Ureaplasma parvum 검사하는 보험등재된 검사는 없습니다.}다만 Candida albicans,  Ureaplasma parvum  Single PCR 검사는 신의료기술 안정성 평가는 되어있습니다. 요양급여행위 결정신청이 안되어 있습니다. (비급여로 검사후 검사실 또는 요양기관이 요양급여 결정 신청이 병행되어야 임의비급여가 아님) \par
