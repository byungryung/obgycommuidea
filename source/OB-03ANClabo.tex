...
\item[\dschemical] CBC → D0002: RBC, WBC, PLT, Hb, HCT
\item[\dschemical] RUA with micro → D2253: RUA / D2202: micro
\item[\dschemical] 혈액형검사 → D1501 : ABO / D1511 : RH
\item[\dschemical] D6911 매독반응검사(매독혈청검사) → D6913: 매독 반응검사[정밀]
\item[\dschemical] 간염검사 → D7015: HBsAg(B형간염 S항원검사)
\item[\dschemical] 풍진검사 → D6542:  바이러스항체(일반) IgG -Rubella, 바이러스항체(일반)Ig M-Rubella
\item[\dschemical] 에이즈검사 → D7212: HIV항체(일반) 또는 D7211:HIV항체(정밀)
\item[\dschemical] 50g 경구 포도당부하검사(임신 24-28주 사이) → D3022:당검사(정량)+약제
\item[\dschemical] C5621 PAP 
...
\begin{itemize}\tightlist  
\item 불규칙항체검사(선별):\sout{B2061006} D156100C \myexplfn{120.84} 원
\item 불규칙항체검사(동정):\sout{B2062006} D156200C \myexplfn{247.61} 원
\end{itemize}
