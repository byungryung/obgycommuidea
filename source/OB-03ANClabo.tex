...
\item[\dschemical] RUA with micro → D2253: RUA / D2201: micro
\item[\dschemical] 혈액형검사 → D1501 : ABO / D1511 : RH
\item[\dschemical] D6911 매독반응검사(매독혈청검사) → D6913: 매독 반응검사[정밀]
\item[\dschemical] 간염검사 → D7001: HBsAg(B형간염 S항원검사)
\item[\dschemical] 풍진검사 → D6531:  바이러스항체(일반) IgG,M -Rubella, D6543 바이러스항체(정밀)IgG,M-Rubella
\item[\dschemical] 에이즈검사 → D7201: HIV항체(일반) 또는 D7211:HIV항체(정밀)
