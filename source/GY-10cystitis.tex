...
\item[\dschemical] \sout{B0030 요일반검사10종까지} D2253 요 일반검사[화학반응-장비측정]-10종까지
\item[\dschemical] \sout{B0041 요침사현미경검사} D2202 요침사검사-[관찰판정-현미경]
\item[\dschemical] \sout{B0043 요침사검사[유세포분석법]} D2201 요침사검사-[관찰판정-육안·장비측정] 
%2017 년 9 월부터는
% 
%균자라든 안자라든
...
\item[\dschemical] \sout{B4133} D5851 일반배양-배양,동정및약제감수성(디스크확산법) 
%\item[\dschemical] B4143 (3) 비뇨기, 생식기검체 Urogenital Specimens \myexplfn{184.12} 원(Microorganism Culture, Identification and Antibiotics Sensitivity Test)
\item[\dschemical] \sout{B4051 미생물배양 및 동정검사}
\item[\dschemical] \sout{B4061 미생물약제감수성 검사(디스크확산법)} 
